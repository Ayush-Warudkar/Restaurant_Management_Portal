    ...
    <div class="mainbody">
      ...
      <div class="row">
        <div class="col-2" style="height:700px;">
          ...
          <center><a href="index.php"><button type="button" class="mbtn act" style="outline:none;"><i class="fa fa-home" aria-hidden="true"></i> Home</button></a></center>
        ...
        <div class="col-10" style="height:700px;background-color:#dee0df;">
          <div class="admdata">
            <div class="grt">DATE: <?php echo date("d/m/Y") ?></div>
          </div>
          <div class="footer">
