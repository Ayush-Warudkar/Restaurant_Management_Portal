          ...
          <div class="admdata">
            ...
            <table>
              <tr>
                ...
                <th style="width:100px;">Served</th>
              </tr>
              <?php
              $order = "SELECT * FROM orders where order_table='$table_id'";
              ...
              <tr>
                ...
                <td>
                  <form action="includes/serve.php" method="post">
                    <input type="hidden" name="tableno" value="<?php echo $table_id ?>">
                    <button type="submit" name="order_id" value="<?php echo $row["order_id"]; ?>" class="mbtn" style="margin-top:0px;margin-bottom:0px;width:100px;">Served</button>
                  </form>
                </td>
              </tr>
              <?php
