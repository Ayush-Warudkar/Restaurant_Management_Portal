    ...
    <div class="mainbody">
      ...
      <div class="row">
        <div class="col-2" style="height:700px;">
          ...
          <center><a href="menuadd.php"><button type="button" class="mbtn act" style="outline:none;"><i class="fa fa-plus" aria-hidden="true"></i> Menu Add</button></a></center>
        ...
        <div class="col-10" style="height:700px;background-color:#dee0df;">
          <div class="admdata">
            <h1 style="text-align:center;font-family: Oswald;margin-top:10px;"><u>ADD MENU</u></h1>
            <div style="border:1px solid #000;padding-bottom:50px;margin-top:100px;">
            <table style="margin-right:auto;margin-left:auto;">
            <form action="includes/additem.php" method="post" style="border:1px solid #000;height:300px;padding:20px;margin-top:50px;">
              <tr>
              <td><label for="Type">Choose Type of Menu:</label></td>
              <td><select id="menu" name="menu" style="border:none;outline:none;">
                <option value="" disabled selected >Choose Option</option>
                <option value="V">Vegetarians</option>
                <option value="N">Non-Vegetarians</option>
                <option value="S">Soft Drinks</option>
             ...
             <tr>
              ...
              <td><input type="text" name="Name_of_Dish" value="" placeholder="Enter Name of Dish" style="outline:none;border:none;"></td><br/>
             </tr>
             <tr>
              <td><label for="Cost">Cost of Dish:</label></td>
              <td><input type="number" name="Cost_of_Dish" value="" placeholder="Enter Cost of Dish" style="outline:none;border:none;"></td><br/>
             </tr>
